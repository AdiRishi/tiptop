      ...
      fields: [
        ...
        },
        {
          ...
          description: {
            ...
            block: true,
            loc: { start: 2782, end: 2826 },
          },
          name: { kind: 'Name', value: 'children', loc: { start: 2829, end: 2837 } },
          arguments: [],
          type: {
            kind: 'NonNullType',
            type: {
              ...
              type: {
                ...
                type: {
                  kind: 'NamedType',
                  name: { kind: 'Name', value: 'Folder', loc: { start: 2840, end: 2846 } },
                  loc: { start: 2840, end: 2846 },
                },
                loc: { start: 2840, end: 2847 },
              },
              loc: { start: 2839, end: 2848 },
            },
            loc: { start: 2839, end: 2849 },
          },
          directives: [],
          loc: { start: 2782, end: 2849 },
        },
        {
          kind: 'FieldDefinition',
          description: {
            ...
            block: true,
            loc: { start: 2852, end: 3034 },
          },
          name: { kind: 'Name', value: 'assets', loc: { start: 3037, end: 3043 } },
          arguments: [
            {
              kind: 'InputValueDefinition',
              name: { kind: 'Name', value: 'assetType', loc: { start: 3044, end: 3053 } },
              type: {
                kind: 'NamedType',
                name: { kind: 'Name', value: 'AssetType', loc: { start: 3055, end: 3064 } },
                loc: { start: 3055, end: 3064 },
              },
              directives: [],
              loc: { start: 3044, end: 3064 },
            },
          ],
          type: {
            kind: 'NonNullType',
            type: {
              ...
              type: {
                ...
                type: {
                  kind: 'NamedType',
                  name: { kind: 'Name', value: 'Asset', loc: { start: 3068, end: 3073 } },
                  loc: { start: 3068, end: 3073 },
                },
                loc: { start: 3068, end: 3074 },
              },
              loc: { start: 3067, end: 3075 },
            },
            loc: { start: 3067, end: 3076 },
          },
          directives: [],
          loc: { start: 2852, end: 3076 },
        },
      ],
      loc: { start: 2382, end: 3078 },
    },
    {
      kind: 'InputObjectTypeDefinition',
      name: { kind: 'Name', value: 'CreateFolderInput', loc: { start: 3086, end: 3103 } },
      directives: [],
      fields: [
        {
          kind: 'InputValueDefinition',
          name: { kind: 'Name', value: 'parentId', loc: { start: 3108, end: 3116 } },
          type: {
            kind: 'NamedType',
          ...
          directives: [],
          loc: { start: 3108, end: 3120 },
        },
        {
          kind: 'InputValueDefinition',
          name: { kind: 'Name', value: 'name', loc: { start: 3123, end: 3127 } },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'String', loc: { start: 3129, end: 3135 } },
              loc: { start: 3129, end: 3135 },
            },
            loc: { start: 3129, end: 3136 },
          },
          directives: [],
          loc: { start: 3123, end: 3136 },
        },
      ],
      loc: { start: 3080, end: 3138 },
    },
  ],
  loc: { start: 0, end: 3139 },
